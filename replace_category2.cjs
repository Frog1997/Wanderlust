...
const regex = /<div className="grid grid-cols-2 gap-3">\s*<div>\s*<label className="block text-xs font-bold text-neutral-700 dark:text-neutral-300 mb-1">\s*類別\s*<\/label>[\s\S]*?由誰先代付 \(Payer\)\s*<\/label>/;

const newStr = `{/* Category Grid */}
                  <div>
